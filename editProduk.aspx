<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="editProduk.aspx.vb" Inherits="editProduk" %>
    ...
    <div class="input-group row justify-content-center">
        <div class="col-7">
            <div class="form-group input-group mb-3">
                ...
                <asp:TextBox ID="tbKode" runat="server" Cssclass="form-control" placeholder="Kode Produk" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group input-group mb-3">
            ...
            <div class="d-flex justify-content-center mb-4 mt-4">
                <asp:Button ID="btUpdate" runat="server" Text="Simpan" CssClass="btn btn-primary ms-2" /> 
